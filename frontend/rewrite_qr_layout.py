        ...
        <div className="col-12">
          <div className="card border-0 rounded-4 shadow-sm h-100">
            <div className="card-body p-4 d-flex flex-column align-items-center justify-content-center text-center">
              ...
              <form onSubmit={simulateQRScan} className="w-100 mb-4" style={{ maxWidth: '500px' }}>
              ...
              {scanMessage && (
                <div className={classNames('mb-4 p-2 rounded-3 small fw-medium', {
              ...
              <div className="bg-light p-3 rounded-4 d-inline-block mt-2">
